        ...
        <nav class="side-nav">
            <ul class="menu menu-vertical sf-arrows">
                @foreach ($menus as $item)
                    ...
                    @elseif ($item->alias == 'danh-muc' && $item->is_active == 1)
                        <li>
                    ...
                    @elseif ($item->alias == 'san-pham' && $item->is_active == 1)
                        <li>
                            <a href="{{ route('category.index') }}" class="sf-with-ul"><i
                                    class="sicon-basket"></i>{{ $item->name }}</a>
                            <div class="megamenu megamenu-fixed-width">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <a href="#" class="nolink pl-0">TRANG SẢN PHẨM</a>
                                        <ul class="submenu">
                                            ...
                                            <li><a href="product.html">NỔI BẬT & ĐANG GIẢM GIÁ</a></li>
                                            <li><a href="product-custom-tab.html">VỚI TAB TÙY CHỈNH</a></li>
                                            <li><a href="product-sidebar-left.html">VỚI THANH BÊN TRÁI</a></li>
                                            <li><a href="product-sidebar-right.html">VỚI THANH BÊN PHẢI</a></li>
                                            <li><a href="product-addcart-sticky.html">THÊM VÀO GIỎ HÀNG CỐ ĐỊNH</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <a href="#" class="nolink pl-0">BỐ CỤC SẢN PHẨM</a>
                                        <ul class="submenu">
                                            <li><a href="product-extended-layout.html">BỐ CỤC MỞ RỘNG</a></li>
                                            <li><a href="product-grid-layout.html">HÌNH ẢNH LƯỚI</a></li>
                                            <li><a href="product-full-width.html">BỐ CỤC TOÀN BỘ CHIỀU RỘNG</a></li>
                                            <li><a href="product-sticky-info.html">THÔNG TIN DÍNH KÈM</a></li>
                                            <li><a href="product-sticky-both.html">DÍNH KÈM BÊN TRÁI & BÊN PHẢI</a></li>
                                            <li><a href="product-transparent-image.html">HÌNH ẢNH TRONG SUỐT</a></li>
                                            <li><a href="product-center-vertical.html">TRUNG TÂM THEO CHIỀU DỌC</a></li>
                                            <li><a href="#">TỰ XÂY DỰNG CỦA BẠN</a></li>
                                        </ul>
                                    </div>
                    ...
                    @elseif ($item->alias == 'gio-hang' && $item->is_active == 1)
                    <li>
                    ...
                    @elseif ($item->alias == 'gioi-thieu' && $item->is_active == 1)
    ...
    <div class="widget widget-banners px-3 pb-3 text-center">
        <div class="owl-carousel owl-theme dots-small">
            ...
            <div class="banner banner4">
                ...
                <div class="banner-layer">
                    <div class="coupon-sale-content">
                        <h4>DRONE + MÁY ẢNH</h4>
                        <h5 class="coupon-sale-text text-gray ls-n-10 p-0 font1"><i>ĐẾN</i><b class="text-white bg-dark font1">$100</b> GIẢM GIÁ</h5>
            ...
            <div class="banner banner5">
                ...
                <div class="banner-layer">
                    <div class="coupon-sale-content">
                        <h5 class="coupon-sale-text ls-n-10 p-0 font1"><i>ĐẾN</i><b class="text-white bg-secondary font1">50%</b> GIẢM GIÁ</h5>
                        <a href="demo1-shop.html" class="btn btn-inline-block btn-dark btn-black ls-0">XEM ƯU ĐÃI</a>
                    </div>
                </div>
            </div>
            ...
            <article class="post">
                ...
                <div class="post-body">
                    ...
                    <div class="post-content">
                        <p>Nhảy vào bố cục điện tử, vẫn không thay đổi. Nó đã trở nên phổ biến từ những năm 1960 với...</p>
