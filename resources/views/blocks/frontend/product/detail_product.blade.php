                ...
                <div class="col-lg-5 col-md-6 product-single-gallery">
                    <div class="product-slider-container">
                        <div class="label-group">
                            <div class="label-group">
                                ...
                                <div class="product-label label-sale">{{round(($product->price - $product->sale) * 100 / $product->price)}}%</div>
                            </div>
                        </div>

                        <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                            <div class="product-item">
                                <img class="product-single-image" src="{{ asset('storage/images/' . $product->image) }}" data-zoom-image="{{ asset('storage/images/' . $product->image) }}" alt="Mô tả hình ảnh sản phẩm" style="max-width: 100%;">
                            </div>
                            @foreach ($productImages as $item)
                            <div class="product-item">
                                <img class="product-single-image" width="468" height="468" src="{{ asset('storage/images')}}/{{ $item->image }}" data-zoom-image="{{ asset('storage/images')}}/{{ $item->image }}" alt="{{ $product->product_name }}" style="padding-top: 0px;">
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div class="prod-thumbnail owl-dots">
                        <div class="owl-dot">
                            ...
                            <img alt="product" width="110" height="110" src="{{ asset('storage/images')}}/{{ $product->image }}" alt="{{ $product->product_name }}"
                                style="padding-top: 0px;">
                        </div>
                            @foreach ($productImages as $item)
                            <div class="owl-dot">
                                <img src="{{ asset('storage/images')}}/{{ $item->image }}" width="110" height="110" alt="product-thumbnail" />
                            </div>                            
                            @endforeach
                    </div>
                </div>
                ...
                <div class="col-lg-7 col-md-6 product-single-details">
                            ...
                            <a href="#">
                                ...
                                <span class="product-popup">
                                    <span class="box-content">
                                        ...
                                        src="{{ asset('storage/images')}}/{{ $product->image }}" alt="{{ $product->product_name }}"
                                            style="padding-top: 0px;">
                    ...
                    <div class="product-action">
                        ...
                        <div class="product-single-qty">
                            <input class="horizontal-quantity form-control" id="quantityInput" name="quantity" type="text" value="1">
                        </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="product-size-content" role="tabpanel" aria-labelledby="product-tab-size">
                    <div class="product-size-content">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="{{ asset('frontend/')}}/assets/images/products/single/body-shape.png" alt="body shape" width="217" height="398">
                            </div>
                            <!-- End .col-md-4 -->
                        ...
                        <div class="comment-list">
                            <div class="comments">
                                <figure class="img-thumbnail">
                                    <img src="{{ asset('frontend/')}}/assets/images/blog/author.jpg" alt="author" width="80" height="80">
                                </figure>
                ...
                <div class="product-default inner-quickview inner-icon">
                    <figure class="img-effect">
                        <a href="{{ route('detail_product', $item->alias) }}">
                            <img width="205" height="205" src="{{ asset('storage/images')}}/{{ $item->image }}" alt="{{ $item->product_name }}">
                    ...
                    <div class="product-details">
                        <div class="category-wrap">
                            <div class="category-list">
                                <a href="demo1-shop.html" class="product-category">{{ $item->category->title }}</a>
                            </div>
        ...
        <div class="product-widgets-container row pb-2">
            ...
            <div class="col-lg-3 col-sm-6 pb-5 pb-md-0">
                ...
                <div class="product-default left-details product-widget ">
                    <figure>
                        <a href="{{route('detail_product', $item->alias ) }}">
                            <img src="{{ asset('storage/images')}}/{{ $item->image }}" width="74" height="74" alt="{{ $item->product_name }}">
                            @if (isset($second_product_images[$item->id]) && count($second_product_images[$item->id]) > 0)
                            @php
                            $randomImage = $second_product_images[$item->id]->random();
                            @endphp
