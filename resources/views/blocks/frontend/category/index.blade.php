...
<nav aria-label="breadcrumb" class="breadcrumb-nav">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('index') }}"><i class="icon-home"></i> Trang chủ</a></li>
        <li class="breadcrumb-item"><a href="{{ route('category.index') }}">Sản phẩm</a></li>
...
@section('page')
    ...
    @else
        <li class="page-item">
            <a class="page-link page-link-btn" href="{{ $products->previousPageUrl() }}"><i
    ...
    @else
        <li class="page-item">
            <a class="page-link page-link-btn" href="{{ $products->nextPageUrl() }}"><i
